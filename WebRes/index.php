...
<?php
    ...
    try {
        $conn = new PDO("mysql:host=$servername;dbname=personalblog", $username, $password);
        // set the PDO error mode to exception
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $query = $conn->query("SELECT * FROM personal_information");
        ...
        <div class="header-top-area">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="logo">
                            <a href="index-2.html">Ali Ahmed</a>
                        </div>
                    </div>
                            ...
                            <div class="navbar">
                                ...
                                <div class="navbar-collapse collapse">
                                    <ul class="nav navbar-nav navbar-right">
                                        ...
                                        <li><a class="smoth-scroll" href="https://aliahmedworld.blogspot.com">Articles</a>
                                        </li>
                    ...
                    <div class="margin-top-150">
                     ...
                     <div class="table-responsive">
					    <table class="table">
                            ...
                            <tr>
								<td>Resume</td>
								<td style="background-color: #f7639a;"><a href="https://drive.google.com/file/d/1nXZ_yHtS58FioCk4iu6QU105-aEboC-E/view?usp=sharing" target="_blank" data-toggle="tooltip" data-placement="top" title="Check Out My Resume">Resume.pdf</a></td>
							</tr>
						</table>
					  </div>
                     </div>
            ...
            <div class="col-md-6 col-sm-6">
				...
				<div class="experience-item">
					...
					<div class="experience-content experience-color-blue">
						<h4>BSc. in Computer Science and Software Engineering</h4>
                        <h6>American International University Bangladesh</h6>
						<p>I completed my graduation with highest academic honor.</p>
					</div>
				 </div>
				...
				<div class="experience-item">
					...
					<div class="experience-content experience-color-blue">
						<h4>ICT trainig on JAVA</h4>
                        <h6>NASSCOM and ICT Ministry Bangladesh/h6>
						<p>This is a LICT project where govt wants to make some skill developer in bangladesh and certified by Washington University, USA.</p>
					</div>
				 </div>
			...
			<div class="col-md-6 col-sm-6">
				...
				<div class="experience-item">
					...
					<div class="experience-content">
						<h4>Brain Station 23 Ltd.</h4>
                        <h6>Currently Working, Software Engineer</h6>
						<p>I am working here as a Software Enigneer and My main responsibility is to develop Android Mobile App.</p>
					</div>
				 </div>
				...
				<div class="experience-item">
					...
					<div class="experience-content">
						<h4>Appinion BD</h4>
                        <h6>Jan 2016- Jun 2016, Android Developer</h6>
						<p>I was the lead android developer and worked some e-commerce and Mockup projects.</p>
					</div>
				 </div>
				...
				<div class="experience-item">
					...
					<div class="experience-content">
						<h4>Microsoft</h4>
                        <h6>2014-2015, Microsoft Student Partners</h6>
					</div>
				 </div>
            ...
            <div class="row">
             ...
             <div class="about-me-text">
               ...
               <ul class="social-icon">
                    <li><a href="https://github.com/aliahmedbd" target="_blank" class="github"><i class="icon-social-github"></i></a></li>
                    <li><a href="https://www.linkedin.com/in/ali-ahmed-info/" target="_blank" class="linkedin"><i class="icon-social-linkedin"></i></a></li>
                    <li><a href="https://www.facebook.com/aliahmed.rohan" target="_blank" class="facebook"><i class="icon-social-facebook"></i></a></li>
                    <li><a href="https://twitter.com/aliahmedrohan" target="_blank" class="twitter"><i class="icon-social-twitter"></i></a></li>
               </ul>
            ...
            <div class="row">
              <div class="col-md-2">
                <ul class="portfolio">
                    ...
                    <li class="filter" data-filter=".wordpress">Web</li>
                </ul>
              </div>
            ...
            <div class="col-md-10">
                <div class="portfolio-inner margin-top-30">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 mix apps">
                        <div class="item">
                            <a href="images/portfolio/1.png" class="portfolio-popup" title="AB Bank Internet Banking">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 mix mockups">
                        <div class="item">
                            <a href="images/portfolio/2.PNG" class="portfolio-popup" title="OneGP">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 mix apps">
                        <div class="item">
                            <a href="images/portfolio/4.jpg" class="portfolio-popup" title="GPAY">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 mix mockups apps">
                        <div class="item">
                            <a href="images/portfolio/5.png" class="portfolio-popup" title="Sheraton Mockup Presentation">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 mix wordpress apps">
                        <div class="item">
                            <a href="images/portfolio/7.PNG" class="portfolio-popup" title="Librarika">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 mix apps mockups wordpress" title="Project Title">
                        <div class="item">
                            <a href="images/portfolio/6.png" class="portfolio-popup">
           ...
           <div class="row">
			...
			<div class="col-md-4 col-sm-6">
				<div class="services-detail">
					...
					<h3>Software Developemnt Consultancy</h3>
					<hr>
				</div>
			</div>
         ...
         <div class="margin-top-30 margin-bottom-50">
           <div class="row">
             ...
             <div class="col-md-offset-3 col-sm-offset-2 col-md-6 col-sm-8">   
               ...
               <div class="row">
                 <div class="contact-us-detail"><a href="mailto:aliahmedaiub@gmail.com">aliahmedaiub@gmail.com</a></div>
                        ...
                        <div class="col-sm-6">
                         ...
                         <div class="col-sm-12">
						  <select id="subject" class="form-group form-control">
							...
							<option>Android App Developemnt</option>
							<option>Android App Design</option>
							<option>Database Design</option>
                            <option>Mobile and Website</option>
